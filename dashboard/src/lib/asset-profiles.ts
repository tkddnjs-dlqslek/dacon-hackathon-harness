...
const COMMON_METRICS: MetricDef[] = [
  { key: "return", label: "수익률", applicable: true, unit: "%" },
  { key: "volatility", label: "변동성", applicable: true, unit: "%" },
  { key: "mdd", label: "최대 낙폭", applicable: true, unit: "%" },
];
...
export const ASSET_PROFILES: Record<AssetType, AssetProfile> = {
  equity_etf: {
    ...
    metrics: [
      ...COMMON_METRICS,
      { key: "sharpe", label: "샤프 비율", applicable: true, unit: "ratio" },
      { key: "beta", label: "베타 (vs SPY)", applicable: true, unit: "ratio" },
    ],
  ...
  bond: {
    ...
    valueMode: "yield",
    metrics: [
      { key: "currentYield", label: "현재 금리", applicable: true, unit: "%" },
      { key: "yieldChange", label: "금리 변화 (1Y, bps)", applicable: true, unit: "bps" },
      { key: "volatility", label: "금리 변동성", applicable: true, unit: "%" },
      { key: "mdd", label: "최대 낙폭", applicable: true, unit: "%" },
    ],
  ...
  fx: {
    ...
    valueMode: "rate",
    metrics: [
      { key: "rateChange", label: "환율 변화", applicable: true, unit: "%" },
      { key: "volatility", label: "FX 변동성", applicable: true, unit: "%" },
      { key: "mdd", label: "최대 낙폭", applicable: true, unit: "%" },
      { key: "range52w", label: "52주 범위", applicable: true, unit: "" },
    ],
  ...
  commodity: {
    ...
    metrics: [
      ...COMMON_METRICS,
      { key: "stockCorr", label: "주식 상관계수", applicable: true, unit: "ratio" },
      { key: "inflationHedge", label: "인플레이션 헤지 점수", applicable: true, unit: "ratio" },
    ],
  ...
  crypto: {
    ...
    metrics: [
      ...COMMON_METRICS,
      { key: "btcCorr", label: "BTC 상관계수", applicable: true, unit: "ratio" },
      { key: "stockCorr", label: "주식 상관계수", applicable: true, unit: "ratio" },
    ],
  ...
  index: {
    ...
    metrics: [
      ...COMMON_METRICS,
      { key: "globalCorr", label: "글로벌 상관계수", applicable: true, unit: "ratio" },
    ],
